...
describe('accounts reducer', () => {
    it('should attach accounts to state after they are loaded', () => {
    ...
    it('should start loading of account details', () => {
    ...
    it('should deposit a given amount into selected account and update both accounts and accountDetails', () => {
    ...
    it('should withdraw a given amount from selected account and update both accounts and accountDetails', () => {
